...
public class Context {
    ...
    public final Counter maintenanceCounter = new Counter(1000);
    public final Counter patientCounter = new Counter(1000);
    public final Counter queueCounter = new Counter(1000);
    ...
    public Context() {
        ...
        maintenances.register(new Maintenance(maintenanceCounter.get(), p1, LocalDate.of(2024, 1, 23), "Annual Checkup: \n Status: Good"));
        maintenances.register(new Maintenance(maintenanceCounter.get(), p2, LocalDate.of(2024, 6, 17), "Illness: Catch a cold."));
        maintenances.register(new Maintenance(maintenanceCounter.get(), p3, LocalDate.of(2025, 1, 8), "Illness: Fever"));
        maintenances.register(new Maintenance(maintenanceCounter.get(), p1, LocalDate.of(2025, 1, 30), "Annual Checkup: \n Status: Good"));

        queue.enqueue(new PatientQueue(p3));
        queue.enqueue(new PatientQueue(p1, LocalDateTime.of(2025,8,29,13,17,30)));
        queue.enqueue(new PatientQueue(p2, LocalDateTime.of(2025,8,29,14,25,27)));
